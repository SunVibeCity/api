...
class UnexpectedError(Model):
    ...
    def __init__(self, code: int=None, message: str=None):  # noqa: E501
        """UnexpectedError - a model defined in Swagger
    ...
    @property
    def code(self) -> int:
        """Gets the code of this UnexpectedError.


        :return: The code of this UnexpectedError.
        :rtype: int
        """
        return self._code
    ...
    def code(self, code: int):
        ...
        :param code: The code of this UnexpectedError.
        :type code: int
        """
        if code is None:
